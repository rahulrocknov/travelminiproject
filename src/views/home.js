        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              ...
              <Link to="/destination" className="home-nav22 bodySmall">
                Destinations
              </Link>
              <Link to="/tours" className="home-nav32 bodySmall">
                Tours
              </Link>
              <Link to="/activities" className="home-nav42 bodySmall">
                Activities
              </Link>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav421 bodySmall">Activities</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Explore the beauty of the world with us</span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Discover hidden gems and breathtaking landscapes around the world."
              ></FeatureCard>
              <FeatureCard
                heading="Immerse in Local Cultures"
                subHeading="Experience authentic traditions, cuisines, and lifestyles of different cultures."
              ></FeatureCard>
              <FeatureCard
                heading="Adventure Activities"
                subHeading="Embark on thrilling adventures like hiking, diving, and wildlife safaris."
              ></FeatureCard>
              <FeatureCard
                heading="Luxurious Accommodations"
                subHeading="Indulge in comfort and luxury with our handpicked selection of premium accommodations."
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>Select the perfect plan for your travel needs</span>
              </span>
            </span>
          </div>
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              <div className="home-container06">
                <span className="home-text36 heading3">Bronze</span>
                <span className="bodySmall">
                  Enjoy our basic features for free
                </span>
              </div>
              <div className="home-container07">
                ...
                <span className="home-free-plan-price">8</span>
              </div>
              <div className="home-container08">
                <div className="home-container09">
                  <span className="home-text40">✔</span>
                  <span className="bodySmall">
                    Access to all tourist guides
                  </span>
                </div>
                ...
                <div className="home-container11">
                  ...
                  <span className="bodySmall">Receive monthly newsletter</span>
                </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              <div className="home-container13">
                <span className="home-text44">Silver</span>
                <span className="bodySmall">
                  Upgrade for more exclusive features
                </span>
              </div>
              ...
              <div className="home-container15">
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">
                    Full access to all tourist guides
                  </span>
                </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">
                  Unlock the ultimate tourism experience
                </span>
              </div>
              ...
              <div className="home-container23">
                ...
                <div className="home-container25">
                  ...
                  <span className="bodySmall">
                    VIP access to all tourist guides
                  </span>
                </div>
                <div className="home-container26">
                  <span className="home-text65">✔</span>
                  <span className="bodySmall">Exclusive premium content</span>
                </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Embark on a journey filled with breathtaking landscapes,
                  vibrant cultures, and unforgettable memories. Our expert
                  guides will ensure you have the trip of a lifetime.
                </span>
                <span>
                  <span
                    dangerouslySetInnerHTML={{
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container29">
            ...
            <nav className="home-nav1">
              <Link to="/" className="activities-nav12 bodySmall">
                Home
              </Link>
              <Link to="/destination" className="home-nav222 bodySmall">
                Destinations
              </Link>
              <Link to="/tours" className="home-nav322 bodySmall">
                Tours
              </Link>
              <Link to="/activities" className="home-nav422 bodySmall">
                Activities
              </Link>
              <Link to="/contact" className="home-nav522 bodySmall">
                Contact
              </Link>
            </nav>
          </div>
          ...
          <div className="home-container30">
            <span className="bodySmall home-text82">
              © 2024 RahulKumarPatel, All Rights Reserved.
            </span>
